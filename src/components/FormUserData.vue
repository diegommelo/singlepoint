<template>
  <div class="register-form-group">
    <div class="register-form-group-item">
      ...
      <BaseInput type="text" id="register-name" v-model.trim="$v.form.name.$model" />
    ...
    <div class="register-form-group-item">
      ...
      <BaseInput type="text" id="register-lastname" v-model.trim="$v.form.lastname.$model" />
      <BaseError :validation="$v.form.lastname.required" v-if="$v.form.lastname.$dirty">Campo obrigatório</BaseError>
    </div>
    <div class="register-form-group-item">
      <label for="register-username">Nome de usuário</label>
      <BaseInput type="text" id="register-username" v-model.trim="$v.form.username.$model" />
    ...
    <div class="register-form-group-item">
      ...
      <BaseInput type="email" id="register-email" v-model.trim="$v.form.email.$model" />
    ...
    <div class="register-form-group-item">
      ...
      <BaseInput type="text" id="register-cpf" v-model="$v.form.cpf.$model" v-mask="['###.###.###-##']" />
    ...
    <div class="register-form-group-item">
      ...
      <BaseInput type="text" id="register-phone" v-model="$v.form.phone.$model" v-mask="['(##) #####-####', '(##) ####-####']" />
    ...
    <div class="register-form-group-item">
      ...
      <BaseInput type="password" id="register-password" v-model.trim="$v.form.password.$model" />
    ...
    <div class="register-form-group-item">
      ...
      <BaseInput type="password" id="register-password-confirm" v-model.trim="$v.password_confirm.$model" />
